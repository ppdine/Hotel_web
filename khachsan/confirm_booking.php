      ...
      if (checkin_val != '' && checkout_val != '') {
        ...
        xhr.onload = function() {
          ...
          if (data.status == 'check_in_out_equal') {
            ...
            // Định dạng tổng số tiền phải trả với dấu chấm phân cách hàng ngàn
            let formattedPayment = Number(data.payment).toLocaleString('vi-VN');
            pay_info.innerHTML = "Số Phòng Trống: " + data.c_rooms + "<br>Số ngày Đặt: " + data.days + "<br>Tổng số tiền phải trả: " + formattedPayment + ' vnđ';
